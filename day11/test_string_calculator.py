...
class TestStringCalculator(unittest.TestCase):
    ...
    def test_add_two_numbers_comma_delimited_string_returns_sum_int(self):
        self.assertEqual(3, add('1,2'))
    def test_add_unknown_number_of_numbers_comma_delimited_string_returns_sum_int(self):
