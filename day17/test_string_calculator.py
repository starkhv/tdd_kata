...
""" Tests for string_calculator.py """
...
class TestStringCalculator(unittest.TestCase):
    ...
    def test_add_newline_char_in_string_works_as_delimiter_returns_sum(self):
        self.assertEqual(6, add("1,2\n3"))

    def test_add_delimiter_declartion_in_string_works_returns_sum(self):
        self.assertEqual(3, add("//;\n1;2"))

    def test_add_negative_numbers_in_string_raises_exception(self):
