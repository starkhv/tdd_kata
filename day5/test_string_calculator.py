...
class TestStringCalculator(unittest.TestCase):
    ...
    def test_add_two_numbers_string_returns_sum(self):
        self.assertEqual(3, add('1,2'))
    def test_add_random_number_of_numbers_string_returns_sum(self):
    ...
    def test_add_with_newline_delimiter_returns_sum(self):
        self.assertEqual(6, add('1,2\n3'))
    def test_add_with_delimiter_declaration_returns_sum(self):
